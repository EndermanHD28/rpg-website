...
export const BREATHING_TREES = {
  "Tempestade": {
    skills: [
      ...
      { id: 'skill_2b', name: 'Despertar Corrosivo', cost: 2, requirements: { strength: 15, resistance: 13, concentration: 11 }, pos: { x: -150, y: 50 }, parent: 'skill_1a', flavor: 'O clima se umidece e se corrói ao seu redor.', effect: 'Quando um golpe reduzir sua **Vida a 0**, rolete **1d20** (Sucesso: **12+**) e, se suceder, **cancele-o** e eleve seu **Foco** até o máximo, mas receba **⚡_Eletrificação** por **3 Turnos**.' },
      { id: 'skill_3a', name: 'Terceira Forma: Tempestade Devastadora', cost: 3, requirements: { strength: 18, concentration: 16, resistance: 15, aptitude: 12, precision: 8 }, pos: { x: -50, y: 150 }, parent: 'skill_2b', flavor: 'O ápice da ira dos céus.', effect: '**75 de Foco**: Imediatamente ataque um inimigo (com seu Dado de Acerto padrão) com uma **Arma Branca** e, se suceder, aumente o **Dado de Acerto** em **+8** (**+3** por Nível); cause **⚡_Eletrificação_Avançada** por **2 Turnos** (também rolete o Dado de Dano, mas aumente-o em **1,5x**).' },
      { id: 'skill_2d', name: 'Terceira Forma: Relâmpago Vertical', cost: 2, requirements: { concentration: 12, agility: 7, intelligence: 6 }, pos: { x: 50, y: 50 }, parent: 'skill_1b', flavor: 'Um ataque vindo de cima com velocidade extrema.', effect: 'Imediatamente ataque um inimigo (com seu Dado de Acerto padrão) com uma **Arma Branca** e, se suceder, adicione a sua **Concentração** aumentada em **+30%** (**+5%** por Nível) ao **Dado de Dano**.' },

  ...
  useEffect(() => {
    if (modal.isOpen) {
      ...
      setLocalData({
        ...
        strength: modal.initialData?.strength !== undefined ? modal.initialData.strength : 5,
        resistance: modal.initialData?.resistance !== undefined ? modal.initialData.resistance : 5,
        aptitude: modal.initialData?.aptitude !== undefined ? modal.initialData.aptitude : 5,
        agility: modal.initialData?.agility !== undefined ? modal.initialData.agility : 5,
        precision: modal.initialData?.precision !== undefined ? modal.initialData.precision : 5,
        concentration: modal.initialData?.concentration !== undefined ? modal.initialData.concentration : 5,
        ...
        class: modal.initialData?.class || 'Nenhuma',
                ...
                onClick={() => {
                  ...
                  if (modal.fields) {
                    ...
                    const npcData = {
                      ...
                      strength: Number(localData.strength) || 5,
                      resistance: Number(localData.resistance) || 5,
                      aptitude: Number(localData.aptitude) || 5,
                      agility: Number(localData.agility) || 5,
                      precision: Number(localData.precision) || 5,
                      concentration: Number(localData.concentration) || 5,
